...
// RUANGOTP API CONFIG
// ==========================================
const USER_ID = process.env.RUANGOTP_API_KEY || 'c0175829-7892-4fc8-9978-895099de7c76';
...
// 1. GET SERVICES LIST - V1 (/v1/services/list)
...
// 2. GET SERVICES LIST - V2 (/v2/services/list)
...
// 3. GET COUNTRIES LIST - V1 (/v1/countries/list)
...
// 4. GET OPERATORS LIST - V1 (/v1/operators/list)
...
// 7. CHECK ORDER - V1 (/v1/check/:order_id)
...
// 8. CHECK ORDER - V2 (/v2/check/:order_id)
...
// 9. CANCEL ORDER - V1 (/v1/cancel/:order_id)
...
// 10. CANCEL ORDER - V2 (/v2/cancel/:order_id)
...
// 14. GET SINGLE SERVICE - V1
app.get('/api/v1/service/:code', async (req, res) => {
    try {
        const { code } = req.params;
        const data = await ruangotpRequest(`/service/${code}`, 'GET', null, false);
        res.json({ success: true, server: 'Server 1', data });
    } catch (error) {
        res.status(500).json({ success: false, server: 'Server 1', error: error.message });
    }
...
// 15. GET SINGLE SERVICE - V2
app.get('/api/v2/service/:code', async (req, res) => {
    try {
        const { code } = req.params;
        const data = await ruangotpRequest(`/service/${code}`, 'GET', null, true);
        res.json({ success: true, server: 'Server 2', data });
    } catch (error) {
        res.status(500).json({ success: false, server: 'Server 2', error: error.message });
    }
    ...
    res.json({
        ...
        endpoints: {
            auth: {
                ...
                me: 'GET /api/auth/me',
                change_apikey: 'POST /api/auth/change-apikey'
            },
            v1: {
                services: 'GET /api/v1/services - /v1/services/list',
                countries: 'GET /api/v1/countries - /v1/countries/list',
                operators: 'GET /api/v1/operators - /v1/operators/list',
                order: 'POST /api/v1/order',
                check: 'GET /api/v1/check/:order_id',
                cancel: 'POST /api/v1/cancel/:order_id',
                balance: 'GET /api/v1/balance',
                service: 'GET /api/v1/service/:code'
            },
            v2: {
                services: 'GET /api/v2/services - /v2/services/list',
                order: 'POST /api/v2/order',
                check: 'GET /api/v2/check/:order_id',
                cancel: 'POST /api/v2/cancel/:order_id',
                balance: 'GET /api/v2/balance',
                service: 'GET /api/v2/service/:code'
            },
