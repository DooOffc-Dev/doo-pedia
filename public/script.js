...
// ==========================================
// RENDER SERVICES - HANYA KALO LOGIN
// ==========================================
async function renderServices() {
    ...
    if (!authToken || !currentUser) {
        grid.innerHTML = `
            <div style="grid-column:1/-1;text-align:center;padding:60px 20px;color:#445566;">
                <i class="fas fa-lock" style="font-size:48px;display:block;margin-bottom:16px;color:#0088FF;"></i>
                <h3 style="color:#fff;font-size:18px;margin-bottom:8px;">Login untuk melihat layanan</h3>
                <p style="font-size:14px;">Silakan login atau daftar untuk mengakses produk</p>
                <button onclick="openAuthModal()" class="btn btn-primary" style="margin-top:16px;">
